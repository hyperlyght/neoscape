...
I went with an approach that used CSS3’s native scrolling ability and scroll snap type to get the images to scroll horizontally. I used the “mandatory” scroll-snap-type to get the images to lock position properly when scrolling from image to image. Flexbox holds the images together and is used to center the images in the viewport as well. 
